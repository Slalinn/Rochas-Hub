...
main.Position = UDim2.new(0.5, -210, 0.45, -190)
...
local sections = { "Walkspeed", "Jumpsize", "Walkspeed Dandys", "Danças", "Esp" }
local icons = { "🏃", "🦘", "🌀", "💃", "👁️" }
...
minBtn.MouseButton1Click:Connect(function()
	...
	main.Size = minimizado and UDim2.new(0,420,0,36) or UDim2.new(0,420,0,380)
end)
