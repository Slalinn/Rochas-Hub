-- Rochas Hub V4 - Minimizar vira quadradinho móvel com imagem customizada (ID: 119416847138099)
-- Corrigido: quadradinho só abre o hub se clicar sem arrastar.
-- Inclui todos os ESPs: Jogadores, NPCs, Geradores, Twisteds. Sliders, switches, animações.
...
local sections = { "Home", "Regretevator", "Dandys World" }
local icons = { "🏠", "⭐", "🌎" }
...
-- DRAG do quadradinho (fix: só abre se click e soltar sem arrastar!!)
